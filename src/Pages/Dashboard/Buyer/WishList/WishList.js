  ...
  return (
    <div className="mx-10">
      {wishList.length < 1 ? (
        ...
        {
            wishList.map(list =>  <div key={list._id} className= "card border-t-4 border-l-4 border-gray-800  rounded-tl-3xl bg-zinc-200">
                ...
                <div className="card-body bg-white text-center px-5 py-0">
                  ...
                  <p className="card-title text-2xl justify-center font-bold text-gray-800">{list.title}</p>
