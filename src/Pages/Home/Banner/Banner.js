          ...
          <div className="flex items-center">
            <div className="w-3/5 lg:px-10 lg:py-14 py-6 px-5">
              ...
              <p className="my-10 hidden lg:block text-gray-200 tracking-widest">
                ...
                maxime eum? Adipisci ipsam eum, nulla vero dolorem placeat
                reprehenderit, vitae, incidunt quod tempore iure totam.
              </p>
            ...
            <div className="w-2/5">
              <img
                className="lg:w-3/4 w-[190px] lg:ml-16 lg:mt-14"
                src={literature}
                alt=""
              />
            </div>
        ...
        >
          <div className="flex items-center flex-col h-full lg:flex-row-reverse lg:gap-20">
            <div className="lg:w-2/5 flex justify-end w-full">
              <img
                className="-rotate-6 lg:w-full w-[160px]"
                src={readingBook}
                alt=""
              />
            </div>
            <div className="lg:w-3/5 w-full lg:px-10 lg:py-14 py-2 px-5 ">
              ...
              <div className="lg:text-5xl text-3xl text-white">
                ...
                <p>
                  for this{" "}
                  <span className="text-sky-300  lg:px-5 bg-violet-900 mt-10">
                    new year occasion
                  </span>
                </p>
              </div>
        ...
        >
          <div className="flex lg:flex-row-reverse h-full lg:items-center lg:gap-20">
            <div className="w-1/2 pl-5 lg:px-10 lg:py-14 pt-28 lg:mb-[10%]">
              <p className="uppercase font-Kaushan text-gray-300">
                Chapter Three
              </p>

              <h1 className="text-5xl lg:text-white text-gray-800">
                Books Bestsellers
              </h1>
            ...
            <div className="w-1/2">
              <img
                className="lg:ml-5 lg:mt-10 mt-5 mr-4"
                src={bestSelling}
                alt=""
              />
            </div>
